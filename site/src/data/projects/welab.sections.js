/* WeLAB's chapters — the case study's own body, and the bulk of its
    ...
    blocks: [
      ...
      },
      {
        ...
        /* the board is two figures, a screen each on the stage: the Tax
           Credits and Who We Are rows here, the other two next. The
