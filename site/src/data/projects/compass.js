    ...
    blocks: [
      {
        type: "p",
        text: {
          en: "I had no users to interview, so I used what the agency publishes about itself instead. That means there is no usability testing in this chapter, no participant quotes and no adoption numbers — and it means being specific about what the three things I could do actually showed.",
      ...
      },
      {
        type: "p",
        text: {
          en: "I ran the screens against Nielsen's heuristics and against a contrast and target-size audit — one person reviewing their own work, which catches the obvious failures and misses the ones you are blind to. The findings are listed with what changed and what I decided to leave.",
      ...
      },
      {
        ...
        note: {
          en: "The full flow, running right here — no install needed.",
