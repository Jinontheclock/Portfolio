...
- **TinyPaws 케이스 스터디** 골격·카피·자산 1차 배포됨. 오너 대기 항목:
  ...
  - «TBD» 토큰 8개(코드 주석 1 포함): 프로그램/수업 명칭·기간·배포 URL(메타 Live Site — cta는 임베드 모달로 대체됨)·lo-fi/hi-fi 참가자 수·영상 크레딧·발표/전시 사실·stats 수치 4개(수치 오기 전까지 stats 블록 자체 미삽입)
...
## 현재 상태 (이 핸드오프 시점)
- Portfolio: `038467a` (TinyPaws 케이스 스터디 + 임베드 데모 모달) 배포 완료.
